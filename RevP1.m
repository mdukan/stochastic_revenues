...
%SAVE new variables - revenues only for CfD (Mer available from former runs
%Merchant - see results for #R001 and #R002 (high and low price scenario)
fname2 = 'C:\Mak\000000  MATLAB MAIN FOLDER 000000\MATLAB_outputs\#R001_GenRev_Vol2\Revenue_Results_Mat\Batch2_47_54_1';
save(fullfile(fname2,'CfD_Rev_Fin_p1.mat'),'CfD_Rev_Fin_p1');
save(fullfile(fname2,'CfD_Rev_Fin_p2.mat'),'CfD_Rev_Fin_p2');
save(fullfile(fname2,'CfD_Rev_Fin_p3.mat'),'CfD_Rev_Fin_p3');
save(fullfile(fname2,'CfD_Rev_Fin_p4.mat'),'CfD_Rev_Fin_p4');
save(fullfile(fname2,'CfD_Rev_Fin_p5.mat'),'CfD_Rev_Fin_p5');
save(fullfile(fname2,'CfD_Rev_Fin_p6.mat'),'CfD_Rev_Fin_p6');
save(fullfile(fname2,'CfD_Rev_Fin_p7.mat'),'CfD_Rev_Fin_p7');
save(fullfile(fname2,'CfD_Rev_Fin_p8.mat'),'CfD_Rev_Fin_p8');

 %WRITE and save Excel files - revenues only for CfD (Mer available from former runs
 %Merchant - see results for #R001 and #R002 (high and low price scenario)
 filename1 = 'C:\Mak\000000  MATLAB MAIN FOLDER 000000\MATLAB_outputs\#R001_GenRev_Vol2\Revenue_Results_Exl\Batch2_47_54_1\CfD_Rev_Fin_p1.xlsx';
 filename2 = 'C:\Mak\000000  MATLAB MAIN FOLDER 000000\MATLAB_outputs\#R001_GenRev_Vol2\Revenue_Results_Exl\Batch2_47_54_1\CfD_Rev_Fin_p2.xlsx';
 filename3 = 'C:\Mak\000000  MATLAB MAIN FOLDER 000000\MATLAB_outputs\#R001_GenRev_Vol2\Revenue_Results_Exl\Batch2_47_54_1\CfD_Rev_Fin_p3.xlsx';
 filename4 = 'C:\Mak\000000  MATLAB MAIN FOLDER 000000\MATLAB_outputs\#R001_GenRev_Vol2\Revenue_Results_Exl\Batch2_47_54_1\CfD_Rev_Fin_p4.xlsx';
 filename5 = 'C:\Mak\000000  MATLAB MAIN FOLDER 000000\MATLAB_outputs\#R001_GenRev_Vol2\Revenue_Results_Exl\Batch2_47_54_1\CfD_Rev_Fin_p5.xlsx';
 filename6 = 'C:\Mak\000000  MATLAB MAIN FOLDER 000000\MATLAB_outputs\#R001_GenRev_Vol2\Revenue_Results_Exl\Batch2_47_54_1\CfD_Rev_Fin_p6.xlsx';
 filename7 = 'C:\Mak\000000  MATLAB MAIN FOLDER 000000\MATLAB_outputs\#R001_GenRev_Vol2\Revenue_Results_Exl\Batch2_47_54_1\CfD_Rev_Fin_p7.xlsx';
 filename8 = 'C:\Mak\000000  MATLAB MAIN FOLDER 000000\MATLAB_outputs\#R001_GenRev_Vol2\Revenue_Results_Exl\Batch2_47_54_1\CfD_Rev_Fin_p8.xlsx';
