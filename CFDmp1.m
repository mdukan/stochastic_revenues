function [k_cfd1,r_cfd1,points_cfd1,y_cfd1,max_y_cfd1,xi_cfd1,peak_CfD1] = CFDmp1 (CfD_p1, x_range)

k_cfd1 = polyder(CfD_p1); % find derivative of above polynomial
r_cfd1 = roots(k_cfd1); % find roots of polynomial created from derivative above
...
y_cfd1 = polyval(CfD_p1,points_cfd1);
